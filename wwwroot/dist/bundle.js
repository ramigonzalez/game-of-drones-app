...
function PlayerRow(props) {
  return _react.default.createElement("div", {
    key: props.round,
    className: "trow statsRow"
  }, _react.default.createElement("div", {
    className: "tcell"
  }, props.item), _react.default.createElement("div", {
    className: "tcell"
  }, props.round));
}

var _default = PlayerRow;
...
var _App = _interopRequireDefault(__webpack_require__(19));
...
function Xf(a, b, c) {
  var d = !1,
      e = Ke;
  var f = b.contextType;
  "object" === _typeof(f) && null !== f ? f = Of.currentDispatcher.readContext(f) : (e = M(b) ? Le : K.current, d = b.contextTypes, f = (d = null !== d && void 0 !== d) ? Me(a, e) : Ke);
  b = new b(c, f);
...
function $f(a, b, c, d) {
  ...
  e.refs = Pf;
  var f = b.contextType;
  "object" === _typeof(f) && null !== f ? e.context = Of.currentDispatcher.readContext(f) : (f = M(b) ? Le : K.current, e.context = Me(a, f));
  f = a.updateQueue;
...
function wg(a, b, c, d, e) {
  ...
  if (null === b.stateNode) null !== a && (a.alternate = null, b.alternate = null, b.effectTag |= 2), Xf(b, c, d, e), $f(b, c, d, e), d = !0;else if (null === a) {
    ...
    var k = g.context,
        l = c.contextType;
    "object" === _typeof(l) && null !== l ? l = Of.currentDispatcher.readContext(l) : (l = M(c) ? Le : K.current, l = Me(b, l));
  ...
  } else g = b.stateNode, h = b.memoizedProps, g.props = b.type === b.elementType ? h : P(b.type, h), k = g.context, l = c.contextType, "object" === _typeof(l) && null !== l ? l = Of.currentDispatcher.readContext(l) : (l = M(c) ? Le : K.current, l = Me(b, l)), m = c.getDerivedStateFromProps, (r = "function" === typeof m || "function" === typeof g.getSnapshotBeforeUpdate) || "function" !== typeof g.UNSAFE_componentWillReceiveProps && "function" !== typeof g.componentWillReceiveProps || (h !== d || k !== l) && Zf(b, g, d, l), kf = !1, k = b.memoizedState, w = g.state = k, y = b.updateQueue, null !== y && (tf(b, y, d, g, e), w = b.memoizedState), h !== d || k !== w || L.current || kf ? ("function" === typeof m && (Qf(b, c, m, d), w = b.memoizedState), (m = kf || Wf(b, c, h, d, k, w, l)) ? (r || "function" !== typeof g.UNSAFE_componentWillUpdate && "function" !== typeof g.componentWillUpdate || ("function" === typeof g.componentWillUpdate && g.componentWillUpdate(d, w, l), "function" === typeof g.UNSAFE_componentWillUpdate && g.UNSAFE_componentWillUpdate(d, w, l)), "function" === typeof g.componentDidUpdate && (b.effectTag |= 4), "function" === typeof g.getSnapshotBeforeUpdate && (b.effectTag |= 256)) : ("function" !== typeof g.componentDidUpdate || h === a.memoizedProps && k === a.memoizedState || (b.effectTag |= 4), "function" !== typeof g.getSnapshotBeforeUpdate || h === a.memoizedProps && k === a.memoizedState || (b.effectTag |= 256), b.memoizedProps = d, b.memoizedState = w), g.props = d, g.state = w, g.context = l, d = m) : ("function" !== typeof g.componentDidUpdate || h === a.memoizedProps && k === a.memoizedState || (b.effectTag |= 4), "function" !== typeof g.getSnapshotBeforeUpdate || h === a.memoizedProps && k === a.memoizedState || (b.effectTag |= 256), d = !1);
...
var _SetupGame = _interopRequireDefault(__webpack_require__(20));

var _Game = _interopRequireDefault(__webpack_require__(21));

var _Score = _interopRequireDefault(__webpack_require__(23));

var _Stats = _interopRequireDefault(__webpack_require__(24));
...
function (_React$Component) {
  ...
  function App() {
    ...
    _this.savePlayersNames = _this.savePlayersNames.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.getWinner = _this.getWinner.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.updateRoundWin = _this.updateRoundWin.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.resetRoundWin = _this.resetRoundWin.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.checkIfEndGame = _this.checkIfEndGame.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.onClickStats = _this.onClickStats.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      fetch("/api/statics").then(function (response) {
    ...
    key: "savePlayersNames",
    value: function savePlayersNames(data) {
      this.setState({
        names: data,
        gameStarted: true
      });
    ...
    key: "onSubmitMove",
    value: function onSubmitMove(move) {
      console.log("APP onSubmitMove() .... START ");
      console.log("Move ... ", move);
      this.setState(function (prevState) {
        var newRoundMoves = prevState.game.roundMoves;
    ...
    value: function resetRoundWin() {
      ...
      this.setState(function (prevState) {
        ...
        var newRoundWin = prevState.game.roundWin;
    ...
    key: "getWinner",
    value: function getWinner(newRoundResult_) {
      var newRoundResult = newRoundResult_;
      console.log("APP getWinner() ....START");
      console.log("CHECKING FOR A ROUND WINNER");
      var m1 = newRoundResult[0];
      var m2 = newRoundResult[1];
      var winResult = -1;
      ...
      if (m1 === "paper" && m2 === "rock") {
        winResult = 1;
      } else if (m1 === "paper" && m2 === "scissor") {
        winResult = 2;
      } else if (m1 === "rock" && m2 === "scissor") {
        winResult = 1;
      } else if (m1 === "rock" && m2 === "paper") {
        winResult = 2;
      } else if (m1 === "scissor" && m2 === "paper") {
        winResult = 1;
      } else if (m1 === "scissor" && m2 === "rock") {
        winResult = 2;
      } else if (m1 === m2) {
        winResult = 0;
      }
    ...
    key: "updateRoundWin",
    value: function updateRoundWin(roundWinner_, newRoundWinCount_) {
      console.log("APP updateRoundWin() ... START");
      var roundWinner = roundWinner_ - 1;
      var newRoundWinCount = newRoundWinCount_;
    ...
    key: "checkIfEndGame",
    value: function checkIfEndGame() {
      console.log("APP checkIfEndGame() ... START");
      var roundWinCount = this.state.game.roundWinCount;
      console.log("APP checkIfEndGame() ... roundWinCount ", roundWinCount);
      var p1_wins = roundWinCount[0];
      var p2_wins = roundWinCount[1];
      var existWinner = false;
      if (p1_wins == 3 || p2_wins == 3) existWinner = true;

      if (existWinner) {
        var winnerPlayerName;
        if (p1_wins == 3) winnerPlayerName = this.state.names.player1Name;else winnerPlayerName = this.state.names.player2Name;
        var data = {
        ...
        this.setState(function (prevState) {
          var roundWinCount_ = prevState.game.roundWinCount;
          console.log(roundWinCount_);
          var p1_wins = roundWinCount_[0];
          var winnerPlayerName;
          if (p1_wins == 3) winnerPlayerName = prevState.names.player1Name;else winnerPlayerName = prevState.names.player2Name;
          return {
            gameStarted: false,
            existWinner: true,
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", null, _react.default.createElement("div", null, _react.default.createElement("h1", null, "GAME OF DRONES"), _react.default.createElement("hr", null)), this.state.showStats ? _react.default.createElement(_Stats.default, {
        state: this.state
      }) : _react.default.createElement("div", null, !this.state.existWinner ? _react.default.createElement("div", null, !this.state.gameStarted ? _react.default.createElement(_SetupGame.default, {
        savePlayersNames: this.savePlayersNames,
        onClickStats: function onClickStats(e) {
          return _this4.onClickStats(e);
        }
      }) : _react.default.createElement("div", null, _react.default.createElement("h1", {
        className: "gameLabels"
      }, "GAME STARTED"), _react.default.createElement("div", {
        className: "container gameBoard"
        ...
        className: "container gameBoard marginTop30"
      }, _react.default.createElement("h1", null, " THE PLAYER ", this.state.winnerPlayer, " IS THE NEW EMPEROR "), _react.default.createElement("label", {
        className: "lblbutton withOverride"
...
/*#__PURE__*/
function (_Component) {
  _inherits(SetupGame, _Component);

  function SetupGame(props) {
    var _this;

    _classCallCheck(this, SetupGame);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(SetupGame).call(this));
    _this.state = {
      player1Name: "",
      player2Name: ""
    };
  ...
  _createClass(SetupGame, [{
    ...
    value: function onSubmit(e) {
      e.preventDefault();
      if (this.state.player1Name === "" || this.state.player2Name === "") alert("Please enter a player name...");else if (this.state.player1Name == this.state.player2Name) alert("Names must be different");else this.props.savePlayersNames(this.state);
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        className: "main"
      }, "Enter Player's Names"), _react.default.createElement("div", {
        className: "form"
      }, _react.default.createElement("form", null, _react.default.createElement("div", null, _react.default.createElement("span", null, "Player 1"), _react.default.createElement("input", {
        name: "player1Name",
        type: "text",
      ...
      })), _react.default.createElement("br", null), _react.default.createElement("div", null, _react.default.createElement("span", null, "Player 2"), _react.default.createElement("input", {
        name: "player2Name",
        type: "text",
        placeholder: "Enter name here..",
      ...
      }, "Start Game!")), _react.default.createElement("button", {
        id: "submitbtn",
        onClick: function onClick(e) {
          return _this2.props.onClickStats(e);
        }
      }, "Watch Stats")));
    }
  }]);
...
var _Round = _interopRequireDefault(__webpack_require__(22));
...
function (_Component) {
  ...
  function Game(props) {
    ...
    _this.onSubmitMove = _this.onSubmitMove.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this._isMounted = false;
    return _this;
  }
  ...
  _createClass(Game, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      var roundMoves = nextProps.state.game.roundMoves;
    ...
    value: function render() {
      ...
      var player1Moves = !this.props.state.game.player1Moves;
      var playerName = player1Moves ? this.props.state.names.player1Name : this.props.state.names.player2Name;
      return _react.default.createElement("div", {
        className: "gameDiv"
      }, _react.default.createElement("br", null), player1Moves ? _react.default.createElement(_Round.default, {
        playerName: playerName,
        state: this.props.state,
        onSubmitMove: this.onSubmitMove
      }) : _react.default.createElement(_Round.default, {
        playerName: playerName,
        state: this.props.state,
        onSubmitMove: this.onSubmitMove
      }));
  ...
  _createClass(Round, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", null, _react.default.createElement("h1", {
        className: "gameLabels"
      }, "ROUND ", this.props.state.game.roundNumber), _react.default.createElement("h2", {
        className: "gameLabels"
      }, this.props.playerName, ", it's your turn!"), _react.default.createElement("span", null, "Select move:"), _react.default.createElement("select", {
        value: this.state.option,
        name: "option",
        onChange: this.handleChange
      }, _react.default.createElement("option", {
        value: ""
      }, "-- Please Choose a Move --"), _react.default.createElement("option", {
        value: "rock"
      }, "Rock"), _react.default.createElement("option", {
        value: "paper"
      }, "Paper"), _react.default.createElement("option", {
        value: "scissor"
      }, "Scissor")), _react.default.createElement("br", null), _react.default.createElement("br", null), _react.default.createElement("button", {
        id: "okBtn",
        onClick: function onClick(e) {
          return _this2.onSubmitMove(e);
        }
      }, "Ok"));
    }
  }]);
...
var _PlayerRow = _interopRequireDefault(__webpack_require__(6));
...
function (_Component) {
  ...
  function Score(props) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(Score).call(this, props));
  }

  _createClass(Score, [{
    key: "render",
    value: function render() {
      var roundWinnersItems = this.props.state.game.roundWin.map(function (item, index) {
        return _react.default.createElement(_PlayerRow.default, {
          key: index + 1,
          item: item,
          round: index + 1
        });
      ...
      return _react.default.createElement("div", {
        className: "gameDiv scorediv"
      }, _react.default.createElement("h1", {
        className: "gameLabels"
      }, "SCORE BOARD"), _react.default.createElement("div", {
        className: "table scoreTable scroll"
      }, _react.default.createElement("div", {
        className: "tbody"
      }, _react.default.createElement("div", {
        className: "trow"
      }, _react.default.createElement("div", {
        className: "tcell theader"
      }, "Winner Player"), _react.default.createElement("div", {
        className: "tcell theader"
      }, "Round #")), roundWinnersItems)));
    }
  }]);
...
function Stats(props) {
  var players = props.state.players.map(function (item, index) {
    return _react.default.createElement(_PlayerRow.default, {
      key: index,
      item: item.name,
      round: item.wins
  ...
  return _react.default.createElement("div", null, _react.default.createElement("h1", null, "STATS BOARD"), _react.default.createElement("div", {
    className: "container gameBoard"
  }, _react.default.createElement("div", {
    className: "table scoreTable scroll"
  }, _react.default.createElement("div", {
    ...
    className: "tcell theader"
  }, "Wins")), players)), _react.default.createElement("label", {
    className: "lblbutton withOverride"
  }, _react.default.createElement("a", {
    id: "playAgainBtn",
